...
public class DiscLevelBuild {
    ...
    public static final String[] testLevelAssetNames = {PathConstants.HERO_WALKING_IMAGE_PATH, PathConstants.ENEMY_GROUND_IMAGE_PATH, PathConstants.LIGHT_IMAGE_PATH};
