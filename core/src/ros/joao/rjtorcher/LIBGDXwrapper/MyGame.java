...
public class MyGame extends Game {
	...
	{
        gameScreen.LoadLevel(ros.joao.rjtorcher.LIBGDXwrapper.gameAdapter.LevelBuilds.LevelBuilder.createSurvivalLevel());
        finishWorldAssets();
	}

    private void startPlatMode()
    {
        gameScreen.LoadLevel(ros.joao.rjtorcher.LIBGDXwrapper.gameAdapter.LevelBuilds.LevelBuilder.createPlatformTestLevel());
        finishWorldAssets(); // ???????????
    }
