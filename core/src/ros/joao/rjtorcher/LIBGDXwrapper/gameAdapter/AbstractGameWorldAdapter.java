...
public abstract class AbstractGameWorldAdapter implements IGameWorldAdapter {
    ...
    protected ros.joao.rjtorcher.gameLogic.LogicWorlds.GameWorld gameLogicWorld;
     ...
     */
    public AbstractGameWorldAdapter(final ros.joao.rjtorcher.Vector2D worldDims, ros.joao.rjtorcher.gameLogic.LogicWorlds.GameWorld gameLogicWorld)
    {
     ...
     */
    protected ros.joao.rjtorcher.Vector2D getCenterScreen(){
        ros.joao.rjtorcher.gameLogic.Characters.CharacterInfo hero = gameLogicWorld.getHeroInfo();
        double x = hero.getXPos()+hero.getXDim()/2.0;
        double y = hero.getYPos()+hero.getYDim()/2.0;
        return new ros.joao.rjtorcher.Vector2D(x,y);
    }
    ...
    public void updateWorld(float deltaT){
        ...
        if(!gameLogicWorld.isGamePlayable()){
            ...
            hud.getGame().SwicthToMenuScreen(ros.joao.rjtorcher.LIBGDXwrapper.MyGame.MenuInstr.ENDGAME);
        }
    }
    ...
    protected void drawBackground()
    {
        ...
        final float backgroundYDim = (float) (cameraHeight * ros.joao.rjtorcher.LIBGDXwrapper.PathConstants.BACKGROUND_PORTION_OF_CAMERA_Y);
        final float backgroundXDim = (float) (backgroundYDim * ros.joao.rjtorcher.LIBGDXwrapper.PathConstants.BACKGROUND_ASPECT_RATIO);
    ...
    public abstract void updateCameraPos(ros.joao.rjtorcher.gameLogic.Characters.CharacterInfo hero, OrthographicCamera gameCamera);
    public abstract ros.joao.rjtorcher.Vector2D getCameraSetup ();
