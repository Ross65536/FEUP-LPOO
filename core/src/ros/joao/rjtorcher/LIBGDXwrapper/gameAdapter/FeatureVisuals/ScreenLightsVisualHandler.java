...
public class ScreenLightsVisualHandler {
    ...
    private ArrayList<ros.joao.rjtorcher.gameLogic.Characters.Light> lights;
    ...
    public ScreenLightsVisualHandler(SpriteBatch drawBatch){
        ...
        lights = new ArrayList<ros.joao.rjtorcher.gameLogic.Characters.Light>();
    }

    public void addNewLight(ros.joao.rjtorcher.gameLogic.Characters.Light lightInfo){
    ...
    private void drawSurroundingDarkness(OrthographicCamera gameCamera){
        ...
        for(ros.joao.rjtorcher.gameLogic.Characters.Light light: lights){
