...
import static ros.joao.rjtorcher.LIBGDXwrapper.gameAdapter.FontLoader.FONTS.*;

public class FontLoader {

    private static TreeMap<FONTS, int[]> fonts;

    public enum FONTS {COASTERSHADOW("coastershadow",Color.ORANGE, Color.BLACK, 5),COASTERSHADOW_BLACK("coastershadow",Color.BLACK, Color.BLACK, ros.joao.rjtorcher.MagicNumbers.COASTERSHADOW_BLACK_BORDER_SIZE);
