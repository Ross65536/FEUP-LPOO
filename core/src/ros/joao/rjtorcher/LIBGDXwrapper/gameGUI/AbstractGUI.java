...
import ros.joao.rjtorcher.LIBGDXwrapper.gameGUI.widgets.WidgetsGeneric;
...
public abstract class AbstractGUI extends InputMultiplexer{
     ...
     */
    protected void addComponent(ros.joao.rjtorcher.LIBGDXwrapper.gameGUI.AbstractSingleStageGUI component){
    ...
    public void dispose(){
        for(InputProcessor comp: menuComponets){
            if(comp instanceof ros.joao.rjtorcher.LIBGDXwrapper.gameGUI.AbstractSingleStageGUI){
                ((ros.joao.rjtorcher.LIBGDXwrapper.gameGUI.AbstractSingleStageGUI)comp).dispose();
            }else
