...
public class HUD extends Stage{
    ...
    public HUD(ros.joao.rjtorcher.Vector2D cameraDim, ros.joao.rjtorcher.LIBGDXwrapper.MyGame game){
        skin = new Skin();
    ...
    private void loadWidgets(){
        ...
        Button.ButtonStyle buttonStyle = ros.joao.rjtorcher.LIBGDXwrapper.gameAdapter.GameAssetHandler.getGameAssetHandler().getUISkinAssetHandler().getUIAsset("pauseButton",Button.ButtonStyle.class);


        elements.put("pauseButton", ros.joao.rjtorcher.LIBGDXwrapper.gameGUI.widgets.WidgetsGeneric.getButton(skin,buttonStyle));
    ...
    private void loadInputlisteners(){
        ((Button)elements.get("pauseButton")).addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                game.SwicthToMenuScreen(ros.joao.rjtorcher.LIBGDXwrapper.MyGame.MenuInstr.PAUSE);
    ...
    public ros.joao.rjtorcher.LIBGDXwrapper.MyGame getGame(){
        return game;
    }
