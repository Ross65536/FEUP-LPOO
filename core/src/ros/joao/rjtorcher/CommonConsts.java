...
public class CommonConsts {
    ...
    {
            if (enType == ros.joao.rjtorcher.gameLogic.Characters.Hero.class)
                return constantsHero;
            else if (enType == ros.joao.rjtorcher.gameLogic.Characters.Platform.class)
                return constantsPlatform;
            else if (enType == ros.joao.rjtorcher.gameLogic.Characters.EnemyGround.class)
                return constantsEnemyGround;
            else if (enType == ros.joao.rjtorcher.gameLogic.Characters.EnemyFlying.class)
