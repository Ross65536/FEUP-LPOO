...
public class Light extends Entity {
     ...
     */
    public Light (final ros.joao.rjtorcher.Vector2D position, final double radious, boolean oscilating, double oscilationLengthFraction) {
        super(position, new ros.joao.rjtorcher.Vector2D(radious,radious));
