...
public class Platform extends Entity{
    ...
    public Platform (final ros.joao.rjtorcher.Vector2D position, final ros.joao.rjtorcher.Vector2D dimensions){
    ...
    private boolean checkWentTrough(Entity ch){
        ...
        ros.joao.rjtorcher.Vector2D prevPosition = ((Character)ch).getPrevPosition();
